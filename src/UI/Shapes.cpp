...
namespace GLPaint
{
    ...
    void Shapes::Shape::ui(bool allowFiller)
    {
        if (allowFiller) {
    ...
    void Shapes::Line::ui(bool allowFiller)
    {
        Shapes::Shape::ui(false);
    ...
    void Shapes::Triangle::ui(bool allowFiller)
    {
        Shapes::Shape::ui(true);
    ...
    void Shapes::Rectangle::ui(bool allowFiller)
    {
        Shapes::Shape::ui(true);
    ...
    void Shapes::Ellipse::ui(bool allowFiller)
    {
        Shapes::Shape::ui(true);
    ...
    void Shapes::Circle::ui(bool allowFiller)
    {
        Shapes::Ellipse::ui(true);
    }

    void Shapes::Bezier::ui(bool allowFiller)
    {
        Shape::ui(false);
